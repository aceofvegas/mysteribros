...
require_once __DIR__ . '/block/CodeTrait.php';
require_once __DIR__ . '/block/HeadlineTrait.php';
require_once __DIR__ . '/block/HtmlTrait.php';
require_once __DIR__ . '/block/ListTrait.php';
require_once __DIR__ . '/block/QuoteTrait.php';
require_once __DIR__ . '/block/RuleTrait.php';

require_once __DIR__ . '/inline/CodeTrait.php';
require_once __DIR__ . '/inline/EmphStrongTrait.php';
require_once __DIR__ . '/inline/LinkTrait.php';
