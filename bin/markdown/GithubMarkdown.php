...
require_once __DIR__ . '/block/TableTrait.php';
require_once __DIR__ . '/block/FencedCodeTrait.php';
require_once __DIR__ . '/inline/StrikeoutTrait.php';
require_once __DIR__ . '/inline/UrlLinkTrait.php';
/**
