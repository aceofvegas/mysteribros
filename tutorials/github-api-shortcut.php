...
$markdown = file_get_contents('../txt/github-api.md');
...
$title = "GitHub API Shortcut";
$subtitle = "Interactive iOS Shortcut To Use GitHub API";
$author = "Daniel Roof";
...
$img = "../img/scut-ghub-api/scut.jpg";
